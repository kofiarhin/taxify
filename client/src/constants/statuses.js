...
export const statusTone = {
  ...
  TRIP_ENDED: 'bg-indigo-50 text-indigo-800 border-indigo-200',
  AWAITING_CLIENT_CONFIRMATION: 'bg-amber-50 text-amber-800 border-amber-200',
  AWAITING_DRIVER_PAYMENT_CONFIRMATION: 'bg-amber-50 text-amber-800 border-amber-200',
